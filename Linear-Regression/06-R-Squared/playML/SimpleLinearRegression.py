...
class SimpleLinearRegression1:
    ...
    def fit(self, x_train, y_train):
        """根据训练数据集 x_train, y_train 训练Simple Linear Regression模型"""
    ...
    def predict(self, x_predict):
        """给定待预测数据集 x_predict，返回 x_predict 的结果向量"""
        assert x_predict.ndim == 1, "Simple Linear Regressor can only solve single feature training fata."
